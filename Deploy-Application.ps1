...
Try {
	...
	[string]$appVendor = 'Epson'
	[string]$appName = 'Stylus Pro 4900 Driver'
	[string]$appVersion = ''
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '11/2/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Write-Log -Message "Installing driver..." -Source 'Uninstallation' -LogType 'CMTrace'
		$exitCode = Execute-Process -Path "$envSystemDrive\Windows\System32\pnputil.exe" -Parameters "/add-driver $dirFiles\E_GF1G1E.INF" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		Write-Log -Message "Driver installed!" -Source 'Uninstallation' -LogType 'CMTrace'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Write-Log -Message "Deleting driver..." -Source 'Uninstallation' -LogType 'CMTrace'
		$exitCode = Execute-Process -Path "$envSystemDrive\Windows\System32\pnputil.exe" -Parameters "/delete-driver oem61.INF /force" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		Write-Log -Message "Driver deleted!" -Source 'Uninstallation' -LogType 'CMTrace'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdRp+vAPYLDClA9qYW3Qb76So
# I1SgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFIs56iP4nRGYcWGXF1q0PZJcmGb0MA0GCSqGSIb3DQEBAQUABIIBgAXgZghM
# PV/BGSjI/OzuhmV/MQFdfl4NZVXQ6kgknSUpv4edzXg53gtT4DWifYTqTtMXxM96
# qzRwZ0/oXhKJkSID/EXJrB/FiFud9AGY0OeqoFkrQpSMMT5ZwNNwPAU2Zaq+RQ8L
# 4nWQK4TnI0Yb0HlqEQlamuGx0p4XLt77OYSym+As7psu5cPhdk6dqt9GYsiCeq0N
# DN/02UwlQ6UF2HWmYrrlofOItjjW50soQBsk+BvNAa0lCbzvbj1bgbq4XOwsg9gE
# SagqX302O4rs6NBku6dEKdcUPYlv9p938U8+brKmgRdIocOF+GIANtlung9Y/Gqw
# 0DWsIVhw4fgUDr1XWIqECJ7cx6BCUYwSKF/YEilNtzRr2hm1fxcTEqGZGqKEJbAW
# zmmarUEODIB5Yd1YSGYXbaYCqS110+RcpQo+k0YxYvmfHI/kxS/Cg7D06rSAYyr2
# i/TUMXwJQ9tpQ7fMDlBOKqESweCSvAik1Nkjv4Ywvp3hR3XP1QAkcpvmpQ==
